...
use bevy_dioxus_interop::{
    BevyDioxusIO, BevyRxChannel, InfoPacket, InfoUpdate, StatusUpdate,
    add_systems_through_world, traits::ErasedSignal,
};
...
#[repr(transparent)]
pub struct BevyComponentSignals(HashMap<TypeId, ErasedSignal>);
