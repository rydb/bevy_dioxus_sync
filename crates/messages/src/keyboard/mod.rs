...
pub(crate) fn handle_keyboard_messages(
        ...
        .read(&keyboard_input_events)
    {
        ...
        let ui_event = match key_state {
            KeyState::Pressed => UiEvent::KeyDown(blitz_key_event),
...
pub fn bevy_key_to_blitz_key(key: &BevyKey) -> Key {
    match key {
        ...
        BevyKey::NumLock => Key::NumLock,
        BevyKey::ScrollLock => Key::ScrollLock,
        BevyKey::Shift => Key::Shift,
        BevyKey::Symbol => Key::Symbol,
        BevyKey::SymbolLock => Key::SymbolLock,
        BevyKey::Meta => Key::Meta,
